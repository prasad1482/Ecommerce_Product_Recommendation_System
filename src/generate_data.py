...
# We can make some users more active than others.
...
# We can make some products more popular than others.
...
event_weights = [0.7, 0.2, 0.1] # More views than purchases

interaction_data['user_id'] = user_choices
interaction_data['product_id'] = product_choices
interaction_data['event_type'] = random.choices(event_types, weights=event_weights, k=num_interactions)
...
print("\nAll data files have been generated. You are now ready for the next step!")